...
def create_RepLKNet31L(drop_path_rate=0.3, num_classes=1000, out_indices=None, use_checkpoint=True, small_kernel_merged=False, pretrained=None, use_sync_bn=True):
    return RepLKNet(large_kernel_sizes=[31,29,27,13], layers=[2,2,18,2], channels=[192,384,768,1536],
                    drop_path_rate=drop_path_rate, small_kernel=5, num_classes=num_classes, out_indices=out_indices, use_checkpoint=use_checkpoint,
                    small_kernel_merged=small_kernel_merged, use_sync_bn=use_sync_bn, pretrained=pretrained)

def create_RepLKNetXL(drop_path_rate=0.3, num_classes=1000, out_indices=None, use_checkpoint=True, small_kernel_merged=False, pretrained=None, use_sync_bn=True):
